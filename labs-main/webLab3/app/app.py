...
login_manager.login_message = 'Для доступа к данной страницк необходимо пройти аутентификацию'
login_manager.login_message_category = 'warning'


app = Flask(__name__)
application = app #Для хостинга
    ...
    if request.method == 'POST':
        ...
        for user in get_users():
            if user['login'] == login_ and user['password'] == password:
                ...
                flash('Вы успешно прошли прoцeдуру аутентификации.', 'success')
                next_ = request.args.get('next')
                return redirect(next_ or url_for('index'))
        flash('Введены неправильные логин и/или пароль.', 'danger')
